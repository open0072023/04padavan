...
DEFAULT_PACKAGES.router:=\
	dnsmasq-full firewall ip6tables ip-full ipset iptables iptables-mod-extra iptables-mod-tproxy kmod-ipt-raw kmod-nf-nathelper kmod-nf-nathelper-extra kmod-tun luci luci-app-arpbind luci-app-autoreboot luci-app-turboacc luci-newapi odhcp6c odhcpd-ipv6only ppp ppp-mod-pppoe
